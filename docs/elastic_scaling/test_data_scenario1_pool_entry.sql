...
-- 3天前：CPU 85%
(1, 'total', 'total', 10, 85.0, 65.0, 850.0, 1000.0, 6500.0, 10000.0, datetime('now', '-3 days'), datetime('now', '-3 days')),
-- 2天前：CPU 90%
(1, 'total', 'total', 10, 90.0, 70.0, 900.0, 1000.0, 7000.0, 10000.0, datetime('now', '-2 days'), datetime('now', '-2 days')),
-- 1天前：CPU 88%
(1, 'total', 'total', 10, 88.0, 68.0, 880.0, 1000.0, 6800.0, 10000.0, datetime('now', '-1 days'), datetime('now', '-1 days')),
-- 今天：CPU 86%
(1, 'total', 'total', 10, 86.0, 66.0, 860.0, 1000.0, 6600.0, 10000.0, datetime('now'), datetime('now'));
